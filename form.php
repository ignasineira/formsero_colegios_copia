                              ...
                              <div class="col-md-8">
                                <div id="ddosis" style="display: none">
                                   ...
                                   <div style="width: 30%; padding-left: 10px">
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input class="form-check-input" id="dosis_unica" type="radio" name="dosis" value="unica" disabled="true" required="true"> Dosis única
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                    ...
                                    <div style="width: 30%">
                                        <input class="form-control" type="date" name="dateVac" id="dateVac" value='today' min="2021-08-01" max="2021-08-31">
                                    </div>
                                </div>
                            </div>
                    </div>
